...
object QSModels {
  ...
  class QSHttpResponse() {
    ...
    def setAccessControlAllowHeaders(headers: String): Unit = this.accessControlAllowHeaders = headers
    def setAccessControlAllowMethods(methods: String): Unit = this.accessControlAllowMethods = methods
    def setAccessControlAllowOrigin(str: String): Unit = this.accessControlAllowOrigin = str
    def setAccessControlExposeHeaders(str: String): Unit = this.accessControlExposeHeaders = str
    def setAccessControlMaxAge(str: String): Unit = this.accessControlMaxAge = str
    ...
    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Access-Control-Allow-Headers")
    def getAccessControlAllowHeaders: String = this.accessControlAllowHeaders

    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Access-Control-Allow-Methods")
    def getAccessControlAllowMethods: String = this.accessControlAllowMethods

    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Access-Control-Allow-Origin")
    def getAccessControlAllowOrigin: String = this.accessControlAllowOrigin

    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Access-Control-Expose-Headers")
    def getAccessControlExposeHeaders: String = this.accessControlExposeHeaders

    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Access-Control-Max-Age")
    def getAccessControlMaxAge: String = this.accessControlMaxAge

    @ParamAnnotation(location = QSConstants.ParamsLocationHeader, name = "Last-Modified")
